    ...
    render: function() {
        ...
        if (this.props.simpleHeader) {
            ...
            if (this.props.editing) {
                ...
                settings_button = (
                    <button className="mx_RoomHeader_button" onClick={this.props.onSettingsClick}>
                        Settings
                    </button>
                );
            }
            ...
            header =
                <div className="mx_RoomHeader_wrapper">
                    ...
                    <div className="mx_RoomHeader_rightRow">
                        ...
                        <button className="mx_RoomHeader_button mx_RoomHeader_voice" onClick={this.onVoiceClick}>
                            Voice Call
                        </button>
                    </div>
                </div>
